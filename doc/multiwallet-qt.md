...
In order to support loading of multiple wallets in csports-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is csports.cpp.
...
Changes to csports.cpp
----------------------
csports.cpp is the entry point into csports-qt, and as such, will require some minor modifications to provide hooks for
