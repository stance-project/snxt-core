...
Intro
-----
Crypto Sports (CSPN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. csports utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run csports-qt.exe.

csports Core is the original csports client and it builds the backbone of the network.
However, it downloads and stores the entire history of csports transactions;
