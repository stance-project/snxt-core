Contributing to Crypto Sports Core
==================================

The Crypto Sports Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Crypto Sports Core project, and is not to be
confused with overall csports Network Protocol consensus changes.

Whether a pull request is merged into Crypto Sports Core rests with the project merge
...
Patches that change csports consensus rules are considerably more involved than
...
Where a patch set proposes to change the csports consensus, it must have been
...
The project leader is the release manager for each Crypto Sports Core release.
