...
RESOURCES += src/qt/csports.qrc src/qt/csports_locale.qrc

TRANSLATIONS += src/qt/locale/csports_bg.ts \
                src/qt/locale/csports_de.ts \
                src/qt/locale/csports_en.ts \
                src/qt/locale/csports_es.ts \
                src/qt/locale/csports_fi.ts \
                src/qt/locale/csports_fr.ts \
                src/qt/locale/csports_it.ts \
                src/qt/locale/csports_ja.ts \
                src/qt/locale/csports_pl.ts \
                src/qt/locale/csports_pt.ts \
                src/qt/locale/csports_ru.ts \
                src/qt/locale/csports_sk.ts \
                src/qt/locale/csports_sv.ts \
                src/qt/locale/csports_vi.ts \
                src/qt/locale/csports_zh_CN.ts \
                src/qt/locale/csports_zh_TW.ts
