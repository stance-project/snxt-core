...
#   c) node1 mines 32 blocks, so now node 0 has 500000CSPN, node 1 has 4250CSPN, node2 has none.
#   d) node0 sends 601 CSPN to node2, in two transactions (301 CSPN, then 300 CSPN).
