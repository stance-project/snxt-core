                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Crypto Sports Core") + " - ";
#ifdef ENABLE_WALLET
...
{
    QSettings settings_;
    QString theme = settings_.value("theme", "").toString();
    QActionGroup* tabGroup = new QActionGroup(this);

    if(theme == "dark"){
        overviewAction = new QAction(tr("&Overview"), this);
        QIcon *ico = new QIcon();
        ico->addPixmap(QPixmap(":/icons/overview"),QIcon::Normal,QIcon::On);
        ico->addPixmap(QPixmap(":/icons/overview_dark"),QIcon::Normal,QIcon::Off);
        overviewAction->setIcon(*ico);
    }else{
    ...
    if(theme == "dark"){
        ...
        QIcon *ico = new QIcon();
        ico->addPixmap(QPixmap(":/icons/send"),QIcon::Normal,QIcon::On);
        ico->addPixmap(QPixmap(":/icons/send_dark"),QIcon::Normal,QIcon::Off);
        sendCoinsAction->setIcon(*ico);
    }else{
    ...
    if(theme == "dark"){
        ...
        QIcon *ico = new QIcon();
        ico->addPixmap(QPixmap(":/icons/receiving_addresses"),QIcon::Normal,QIcon::On);
        ico->addPixmap(QPixmap(":/icons/receiving_addresses_dark"),QIcon::Normal,QIcon::Off);
        receiveCoinsAction->setIcon(*ico);
    }else{
        receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive"), this);
    }
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and csports: URIs)"));
    ...
    if(theme == "dark"){
        ...
        QIcon *ico = new QIcon();
        ico->addPixmap(QPixmap(":/icons/history"),QIcon::Normal,QIcon::On);
        ico->addPixmap(QPixmap(":/icons/history_dark"),QIcon::Normal,QIcon::Off);
        historyAction->setIcon(*ico);
    }else{
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        if(theme == "dark"){
            ...
            QIcon *ico = new QIcon();
            ico->addPixmap(QPixmap(":/icons/masternodes"),QIcon::Normal,QIcon::On);
            ico->addPixmap(QPixmap(":/icons/masternodes_dark"),QIcon::Normal,QIcon::Off);
            masternodeAction->setIcon(*ico);
        }else{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Crypto Sports Core"), this);
    aboutAction->setStatusTip(tr("Show information about Crypto Sports Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for csports"));
    ...
    openAction->setStatusTip(tr("Open a csports: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Crypto Sports Core help message to get a list with possible csports command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Crypto Sports Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the Crypto Sports network", "", count));
}
...
{
    QString strTitle = tr("Crypto Sports Core"); // default title
...
void UnitDisplayStatusBarControl::updateDisplayUnit(int newUnits)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        setPixmap(QIcon(":/icons/unit_" + BitcoinUnits::id(newUnits)).pixmap(56, STATUSBAR_ICONSIZE));
    } else {
        setPixmap(QIcon(":/icons/unit_t" + BitcoinUnits::id(newUnits)).pixmap(56, STATUSBAR_ICONSIZE));
    }
}
