...
/** Utility functions used by the csports Qt UI.
 */
namespace GUIUtil
{
...
// Render CSPN addresses in monospace font
...
// Parse "csports:" URI into recipient object, return true on successful parsing
