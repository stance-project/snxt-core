...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        intro.setWindowIcon(QIcon(":icons/csports"));
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Crypto Sports Core"),
     ...
     * override -datadir in the csports.conf file in the default data directory
     * (to be consistent with csportsd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
