...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Crypto Sports Core csports-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  csports-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded csports transaction") + "\n" +
                               "  csports-tx [options] -create [commands]   " + _("Create hex-encoded csports transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded csports transaction
