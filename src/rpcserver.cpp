...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "csports server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* csports features */
        {"csports", "masternode", &masternode, true, true, false},
        {"csports", "listmasternodes", &listmasternodes, true, true, false},
        {"csports", "getmasternodecount", &getmasternodecount, true, true, false},
        {"csports", "masternodeconnect", &masternodeconnect, true, true, false},
        {"csports", "masternodecurrent", &masternodecurrent, true, true, false},
        {"csports", "masternodedebug", &masternodedebug, true, true, false},
        {"csports", "startmasternode", &startmasternode, true, true, false},
        {"csports", "createmasternodekey", &createmasternodekey, true, true, false},
        {"csports", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"csports", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"csports", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"csports", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"csports", "getmasternodescores", &getmasternodescores, true, true, false},
        {"csports", "mnbudget", &mnbudget, true, true, false},
        {"csports", "preparebudget", &preparebudget, true, true, false},
        {"csports", "submitbudget", &submitbudget, true, true, false},
        {"csports", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"csports", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"csports", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"csports", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"csports", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"csports", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"csports", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"csports", "checkbudgets", &checkbudgets, true, true, false},
        {"csports", "mnsync", &mnsync, true, true, false},
        {"csports", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> csports-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9778/\n";
}
